...
export default function ProductDetail() {
  ...
  const [messages, setMessages] = useState<{ from: "me" | "shop"; text: string; time: number }[]>([
    { from: "shop", text: "Xin chào! Mình có thể hỗ trợ gì cho bạn?", time: Date.now() },
  ]);
                          ...
                          >
                            <div
                              className={`max-w-[75%] rounded-2xl px-3 py-2 text-sm ${
                                m.from === "me" ? "bg-rose-600 text-white" : "bg-white border"
                              }`}
                            >
                              {m.text}
                            </div>
